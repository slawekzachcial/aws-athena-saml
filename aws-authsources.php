...
$config = array(
    ...
    'example-userpass' => array(
        ...
        'user1:user1pass' => array(
            ...
            'https://aws.amazon.com/SAML/Attributes/RoleSessionName' => 'user1@example.com',
        ),
        ...
        'user3:user3pass' => array(
            ...
            'https://aws.amazon.com/SAML/Attributes/Role' => array('arn:aws:iam::'.getenv('AWS_ACCOUNT_ID').':role/redshift-saml-idp,arn:aws:iam::'.getenv('AWS_ACCOUNT_ID').':saml-provider/athena-saml-idp'),
